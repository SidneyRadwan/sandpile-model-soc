...
Sandpile Model Simulation to
demonstrate Self Organised Criticality!

Adjust the params below or
just run as is.

Written by Sidney Radwan 8/9/21
...
class Sandpile:
    """
    This class creates a sandpile model simulation to
    demonstrate Self Organised Criticality. Important
    to note that sand can fall off the edges.
    """
    ...
    def run(self):
        """
        Runs sandpile simulation for T iterations and gives logarithmic
        scale plot of sand avalanche power-law distribution.
        """
